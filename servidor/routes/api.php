...
Route::group([
    ...
    Route::get('/count-waiting', 'App\Http\Controllers\ConsignmentController@countWaitingUsers');
    Route::get('/waiting', 'App\Http\Controllers\ConsignmentController@listWaitingUsers');
    Route::post('/{id}/devolution', 'App\Http\Controllers\ConsignmentController@listUserDevolution');
    Route::post('/consignment/{id}/changestate', 'App\Http\Controllers\ConsignmentController@changeStateConsignment');
    Route::get('/{id}/listUserConsignments', 'App\Http\Controllers\ConsignmentController@listUserConsignments');
    Route::post('/{id}/loadConsignmentFile', 'App\Http\Controllers\ConsignmentController@loadConsignmentFile');
    Route::post('/{id}/updateConsignmentFile', 'App\Http\Controllers\ConsignmentController@updateConsignmentFile');
    Route::get('/file/consignment/{id}', 'App\Http\Controllers\ConsignmentController@showFileConsignment');
